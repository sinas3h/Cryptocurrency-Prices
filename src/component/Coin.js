...
const Coin = (props) => {
    const {id , name , image , market_cap_rank , price_change_percentage_24h, symbol , current_price , market_cap} = props.data
    return (
        <div className={style.container}>
            ...
            <p className={style.price}>$ {current_price.toFixed(2).toLocaleString()}</p>
